...
class Mime
{
    ...
    public function setType(string $fileExtension, string $contentType) : self
    {
        $this->types[$fileExtension] = $contentType;
        return $this;
    }

    public function setDefaultType (string $contentType) : self
    {
        $this->defaultType = $contentType;
        return $this;
    }


    public function getContentTypeByExtension (string $extension)
    {
