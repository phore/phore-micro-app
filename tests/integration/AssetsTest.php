...
class AssetsTest extends TestCase
{
    ...
    public function testAssetsCantEscapeFolder()
    {
        ...
        $this->assertStringContainsString("Bogus characters in assetFile.", $ret['error']["msg"]);
    }

    public function testAssets404RaisedOnNotFound()
    {
        $ret = phore_http_request(self::TEST_URL . "/assets/some/undefined.png")->send(false);
        $this->assertStringContainsString("Asset 'some/undefined.png' not found.", $ret->getBodyJson()['error']["msg"]);
    ...
    public function testAssets500RaisedOnUnsecureExtension()
    {
        ...
        $this->assertStringContainsString("Asset extension 'php' is not allowed. (Path: 'some/undefined.php') Use App::assets()::addAllowedExtension('php') to allow.", $ret->getBodyJson()['error']["msg"]);
